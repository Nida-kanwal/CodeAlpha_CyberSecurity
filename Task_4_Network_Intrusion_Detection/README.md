...
CodeAlpha Cyber Security Internship — Task 4 Submitted by: Nida Kanwal
...
Full detailed report: NIDS_Snort_Report_Nida_Kanwal.pdf

Project: Network Intrusion Detection System Using Snort Task: CodeAlpha Cyber Security Internship — Task 4
